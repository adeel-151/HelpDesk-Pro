...
export function PublicFooter() {
  return (
    <footer className="bg-white dark:bg-black pt-20 pb-10 border-t border-black/10 dark:border-white/10">
      <div className="container mx-auto px-4 grid grid-cols-2 md:grid-cols-5 gap-12 mb-16">
        <div className="col-span-2">
          <div className="flex items-center space-x-3 mb-6">
            <svg width="32" height="32" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-black dark:text-white">
          ...
          <p className="text-xs text-black/50 dark:text-white/50 uppercase tracking-widest leading-relaxed max-w-sm mb-6">
            A meticulously designed workspace for modern support teams. Build relationships, not backlogs.
          </p>
        </div>
        <div>
          <h4 className="font-bold mb-6 text-black dark:text-white text-sm uppercase tracking-[0.2em]">
            Product
          </h4>
          <ul className="space-y-4 text-xs uppercase tracking-widest text-black/50 dark:text-white/50">
            <li>
              <Link to="/features" className="hover:text-black dark:hover:text-white transition-colors">Features</Link>
            </li>
            <li>
              <Link to="/pricing" className="hover:text-black dark:hover:text-white transition-colors">Pricing</Link>
            </li>
            <li>
              <a href="#" className="hover:text-black dark:hover:text-white transition-colors">Security</a>
            </li>
            <li>
              <a href="#" className="hover:text-black dark:hover:text-white transition-colors">Changelog</a>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-4 text-xs uppercase tracking-widest text-black/50 dark:text-white/50">
            <li>
              <Link to="/kb" className="hover:text-black dark:hover:text-white transition-colors">Help Center</Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-4 text-xs uppercase tracking-widest text-black/50 dark:text-white/50">
            ...
            <li>
              <Link to="/contact" className="hover:text-black dark:hover:text-white transition-colors">Contact Support</Link>
            </li>
            <li>
              <a href="#" className="hover:text-black dark:hover:text-white transition-colors">Partners</a>
            </li>
          </ul>
        </div>
      </div>
      <div className="container mx-auto px-4 pt-8 border-t border-black/10 dark:border-white/10 flex flex-col md:flex-row items-center justify-between text-[10px] text-black/30 dark:text-white/30 uppercase tracking-[0.2em]">
        ...
        <div className="flex gap-6 mt-6 md:mt-0">
          ...
          <a href="#" className="hover:text-black dark:hover:text-white transition-colors">Cookie Settings</a>
        </div>
      </div>
    </footer>
  );
