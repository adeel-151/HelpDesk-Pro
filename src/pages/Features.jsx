...
export default function Features() {
  return (
    <>
      ...
      <section className="py-24 border-b border-black/10 dark:border-white/10 bg-white dark:bg-black">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            >
              <div className="w-16 h-16 bg-transparent border border-black/20 dark:border-white/20 text-black dark:text-white flex items-center justify-center">
                <Clock className="h-8 w-8" />
              </div>
              <h2 className="text-2xl md:text-3xl font-black uppercase tracking-[0.2em] text-black dark:text-white">SMART SLAs & TIMERS</h2>
              <p className="text-sm text-black/50 dark:text-white/50 tracking-widest leading-relaxed uppercase">
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3 text-xs uppercase tracking-widest text-black/80 dark:text-white/80"><CheckCircle className="text-primary h-5 w-5 shrink-0" /> Color-coded urgency indicators</li>
                <li className="flex items-center gap-3 text-xs uppercase tracking-widest text-black/80 dark:text-white/80"><CheckCircle className="text-primary h-5 w-5 shrink-0" /> Real-time status updates</li>
                <li className="flex items-center gap-3 text-xs uppercase tracking-widest text-black/80 dark:text-white/80"><CheckCircle className="text-primary h-5 w-5 shrink-0" /> One-click reassignment</li>
              </ul>
            </motion.div>
            <motion.div
              variants={fadeLeft}
            ...
            >
              ...
              <div className="relative z-10 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 p-2 overflow-hidden hover:border-black/30 dark:hover:border-white/30 transition-colors duration-500">
                <img 
                  src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=2070&q=80" 
                  alt="Dashboard Data" 
                  className="w-full h-[350px] object-cover mix-blend-multiply dark:mix-blend-luminosity opacity-50 group-hover:opacity-80 transition-opacity duration-500"
                />
              </div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col md:flex-row-reverse gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-2xl md:text-3xl font-black uppercase tracking-[0.2em] text-black dark:text-white">EXPRESSIVE COMMUNICATION</h2>
              <p className="text-sm text-black/50 dark:text-white/50 tracking-widest leading-relaxed uppercase">
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3 text-xs uppercase tracking-widest text-black/80 dark:text-white/80"><CheckCircle className="text-accent h-5 w-5 shrink-0" /> Full Markdown Support</li>
                <li className="flex items-center gap-3 text-xs uppercase tracking-widest text-black/80 dark:text-white/80"><CheckCircle className="text-accent h-5 w-5 shrink-0" /> Private Internal Notes</li>
                <li className="flex items-center gap-3 text-xs uppercase tracking-widest text-black/80 dark:text-white/80"><CheckCircle className="text-accent h-5 w-5 shrink-0" /> Drag-and-drop file attachments</li>
              </ul>
            </motion.div>
            <motion.div
              variants={fadeRight}
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6, delay: 0.2 }}
              className="flex-1 w-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 p-8 relative overflow-hidden"
            >
              ...
              <div className="space-y-3 relative z-10">
                ...
                <div className="p-4 bg-white dark:bg-black border border-black/10 dark:border-white/10 font-mono text-xs text-black/70 dark:text-white/70">
                  <span className="text-primary">```javascript</span><br/>
                  <span className="text-accent">function</span> resolveIssue() {'{'}<br/>
                  &nbsp;&nbsp;<span className="text-primary">return</span> <span className="text-black dark:text-white">"Customer Happy!"</span>;<br/>
                  {'}'}<br/>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-2xl md:text-3xl font-black uppercase tracking-[0.2em] text-black dark:text-white">DEFLECT TICKETS</h2>
              <p className="text-sm text-black/50 dark:text-white/50 tracking-widest leading-relaxed uppercase">
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3 text-xs uppercase tracking-widest text-black/80 dark:text-white/80"><CheckCircle className="text-primary h-5 w-5 shrink-0" /> Global lightning-fast search</li>
                <li className="flex items-center gap-3 text-xs uppercase tracking-widest text-black/80 dark:text-white/80"><CheckCircle className="text-primary h-5 w-5 shrink-0" /> Category organization</li>
                <li className="flex items-center gap-3 text-xs uppercase tracking-widest text-black/80 dark:text-white/80"><CheckCircle className="text-primary h-5 w-5 shrink-0" /> WYSIWYG Article Editor</li>
              </ul>
            </motion.div>
            <motion.div
              variants={fadeLeft}
      ...
      {/* Security */}
      <section className="py-24 bg-white dark:bg-black border-b border-black/10 dark:border-white/10 relative overflow-hidden">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-black uppercase tracking-[0.2em] mb-8 text-black dark:text-white">ENTERPRISE-GRADE SECURITY</h2>
          <p className="text-xs md:text-sm text-black/50 dark:text-white/50 tracking-widest uppercase mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            {[
              ...
              <motion.div
                ...
                className="bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 p-6 hover:border-primary/50 transition-colors"
              >
                <h4 className="font-bold text-sm text-black dark:text-white uppercase tracking-widest mb-2">{card.title}</h4>
                <p className="text-black/50 dark:text-white/50 text-xs tracking-wide uppercase leading-relaxed">{card.desc}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
      ...
      <section className="py-24 bg-white dark:bg-black border-b border-black/10 dark:border-white/10">
        <div className="container mx-auto px-4 max-w-4xl">
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-3xl md:text-5xl font-black uppercase tracking-[0.2em] text-black dark:text-white text-center mb-16"
          >
            SYSTEM COMPARISON
          </motion.h2>
            ...
            <div className="p-6 sm:p-10 bg-black/5 dark:bg-white/5">
              ...
              <ul className="space-y-6">
                {["Cluttered interfaces", "Requires page reloads", "Weeks of training", "Plain text only"].map((item) => (
                  <li key={item} className="flex items-center gap-3 text-black/50 dark:text-white/50 text-xs uppercase tracking-widest">
                    <div className="w-5 h-5 border border-black/20 dark:border-white/20 flex items-center justify-center text-black/50 dark:text-white/50 text-[10px] shrink-0">✕</div>
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <div className="p-6 sm:p-10 bg-primary/10 md:border-l border-t md:border-t-0 border-black/10 dark:border-white/10 relative">
              ...
              <ul className="space-y-6 relative z-10">
                {["Intuitive Cyber UI", "Real-time WebSockets", "Zero training required", "Full Markdown Support"].map((item) => (
                  <li key={item} className="flex items-center gap-3 text-black dark:text-white text-xs uppercase tracking-widest font-bold">
